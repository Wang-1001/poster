...
import { BillInfoComponent } from 'app/entities/bill-info/bill-info.component';
...
describe('Component Tests', () => {
  describe('BillInfo Management Component', () => {
    let comp: BillInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BillInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.billInfos && comp.billInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
